      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10 leading-relaxed font-medium">
            Com presença ostensiva e mobilidade estratégica, a UP Tower<span className="text-[0.5em] align-top relative top-[0.1em] text-inherit">®</span> posiciona a segurança no ponto certo, no momento certo — prevenindo ocorrências e elevando o nível de controle das operações.
          </p>
          <a
            href="#contato"
