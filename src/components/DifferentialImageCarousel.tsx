...
const imagesMap = import.meta.glob("@/assets/NOVAS FOTOS/estrutura-unica/*.{png,jpg,jpeg,PNG,JPG,JPEG}", {
  eager: true,
  import: "default",
});

// Extrair URLs únicas e embaralhar
const uniqueImages = Array.from(new Set(Object.values(imagesMap) as string[]));
const images = [...uniqueImages]
  .sort(() => Math.random() - 0.5)
  .slice(0, 15);

const DifferentialImageCarousel = () => {
...
export default DifferentialImageCarousel;
